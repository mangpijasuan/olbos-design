...
**Status:** Vision captured. Phase 0 audit complete. **Phase 1a (rebrand & cleanup) complete.** Phase 1b–1e (event-type registry, theme/fabric split, generic renderer, organizations) not yet started — awaiting a scoping decision (see [Recommended Path Forward](#recommended-path-forward)).
